...
const submit = () => {
    form.post(route('post.comment.report', {commentId: props.commentId}), {onSuccess: () => emit('cancel')});
};
</script>

<template>
    <Head :title="'Reporting ' + username" />
    <div
            ...
            <form @submit.prevent="submit">
                ...
                <div class="mb-4">
                    ...
                    <textarea
                        ...
                        placeholder="Explain why the user should be banned"
                    ></textarea>
